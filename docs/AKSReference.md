# One-to-Many AKS Reference

Thank you for taking the time to learn about AKS Infrastrucutre Multitenancy in an ISV/Startup context.  The following is a list of the reference links from the presentation:

## AKS
* [Best practices for cluster isolation - Azure Kubernetes Service](https://docs.microsoft.com/en-us/azure/aks/operator-best-practices-cluster-isolation)
